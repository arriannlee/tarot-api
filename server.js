...
const card = {
  ...
  'six of swords': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Transition: The Six of Swords upright represents a transition or journey towards a better place or state of mind. It signifies moving away from difficulties, finding solace, and embarking on a path of healing and growth.',
    'uprightDescription2': 'Healing: This card embodies healing and recovery. The Six of Swords signifies leaving behind emotional pain, seeking professional help or guidance, and taking steps towards emotional well-being.',
    'uprightDescription3': 'Moving On: The Six of Swords upright symbolizes leaving the past behind and moving on to a more positive future. It represents releasing attachments, embracing change, and looking forward to new opportunities.',
    'uprightDescription4': 'Support: This card represents receiving support and assistance during challenging times. The Six of Swords signifies having people around you who offer guidance, understanding, and help to navigate difficult situations.',
    'uprightDescription5': 'Hope: The Six of Swords embodies hope and a brighter outlook. It signifies believing in a better future, having faith in the healing process, and trusting that positive change is possible.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Resistance: The Six of Swords reversed suggests resistance to change or difficulty in letting go of the past. It signifies holding onto negative experiences, clinging to old patterns, or feeling stuck in a stagnant situation.',
    'reversedDescription2': 'Turbulence: This card represents turbulence or challenges during the transitional period. The Six of Swords reversed signifies encountering obstacles, setbacks, or emotional upheaval while trying to move forward.',
    'reversedDescription3': 'Delayed Progress: The Six of Swords in reverse symbolizes a delay in progress or a slower-than-expected journey towards healing. It signifies the need for patience, perseverance, and addressing any unresolved issues or emotions.',
    'reversedDescription4': 'Lack of Support: This card embodies a lack of support or feeling isolated during a difficult transition. The Six of Swords reversed suggests the importance of seeking assistance, reaching out for help, or building a support network.',
    'reversedDescription5': 'Uncertainty: In the reversed position, the Six of Swords represents uncertainty about the future or hesitancy in embracing change. It signifies the need for self-reflection, gaining clarity, and finding inner strength to overcome doubts and fears.',
  ...
  'seven of swords': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Deception: The Seven of Swords upright represents deception, trickery, or dishonesty. It signifies the presence of hidden agendas, secret actions, or sneaky behavior within a situation or relationship.',
    'uprightDescription2': 'Stealth: This card embodies stealth and strategic planning. The Seven of Swords signifies the need for caution, careful observation, and using clever tactics to achieve your goals.',
    'uprightDescription3': 'Secrecy: The Seven of Swords upright symbolizes secrecy or keeping information hidden. It represents the importance of confidentiality, protecting yourself, or maintaining privacy in certain circumstances.',
    'uprightDescription4': 'Independence: This card represents independence or taking a self-reliant approach. The Seven of Swords signifies the desire to handle situations on your own terms, asserting individuality, and seeking personal freedom.',
    'uprightDescription5': 'Strategy: The Seven of Swords embodies strategic thinking and planning. It signifies the need for considering all angles, weighing options, and devising a thoughtful approach to overcome challenges or achieve objectives.Exposure: The Seven of Swords reversed suggests exposure or the potential for secrets to be revealed. It signifies the truth coming to light, hidden motives being uncovered, or the consequences of dishonest actions.',
    ...
    'reversedKeyword1': 'Accountability: This card represents taking responsibility for your actions. The Seven of Swords reversed signifies the need to face the consequences of deceitful behavior, acknowledging mistakes, and making amends.',
    'reversedKeyword2': '',
    'reversedKeyword3': '',
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Exposure: The Seven of Swords reversed suggests exposure or the potential for secrets to be revealed. It signifies the truth coming to light, hidden motives being uncovered, or the consequences of dishonest actions.',
    'reversedDescription2': 'Accountability: This card represents taking responsibility for your actions. The Seven of Swords reversed signifies the need to face the consequences of deceitful behavior, acknowledging mistakes, and making amends.',
    'reversedDescription3': 'Transparency: The Seven of Swords in reverse symbolizes transparency and open communication. It signifies the importance of honesty, integrity, and building trust in relationships or situations.',
    'reversedDescription4': 'Vulnerability: This card embodies vulnerability or feeling exposed. The Seven of Swords reversed suggests the need to let go of defense mechanisms, be open to receiving support, and embracing authenticity.',
    'reversedDescription5': 'Integrity: In the reversed position, the Seven of Swords represents acting with integrity and maintaining ethical standards. It signifies the importance of being truthful, fair, and honorable in all dealings.',
  ...
  'eight of swords': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Restriction: The Eight of Swords upright represents a sense of restriction or feeling trapped in a challenging situation. It signifies limitations, self-imposed boundaries, or a lack of perspective that hinders progress.',
    'uprightDescription2': 'Powerlessness: This card embodies a feeling of powerlessness or being at the mercy of circumstances. The Eight of Swords signifies a perceived inability to change your situation, experiencing fear or self-doubt that holds one back.',
    'uprightDescription3': 'Self-Sabotage: The Eight of Swords upright symbolizes self-sabotaging thoughts or behaviors. It represents a negative mindset, self-limiting beliefs, or creating unnecessary obstacles that prevent growth or success.',
    'uprightDescription4': 'Isolation: This card represents isolation or a sense of being cut off from others. The Eight of Swords signifies feeling alone, lacking support or assistance, or struggling to reach out for help when needed.',
    'uprightDescription5': 'Perception: The Eight of Swords embodies distorted perception or limited understanding of the situation. It signifies the importance of examining your thoughts and beliefs, challenging assumptions, and seeking a broader perspective.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Liberation: The Eight of Swords reversed suggests liberation from self-imposed limitations. It signifies breaking free from constraints, gaining a fresh perspective, and regaining a sense of personal power.',
    'reversedDescription2': 'Empowerment: This card represents empowerment and regaining control over your life. The Eight of Swords reversed signifies recognizing inner strength, embracing autonomy, and taking proactive steps to overcome obstacles.',
    'reversedDescription3': 'Clarity: The Eight of Swords in reverse symbolizes gaining clarity and a clearer understanding of the situation. It signifies releasing self-doubt, seeing opportunities for growth, and finding a way forward with renewed confidence.',
    'reversedDescription4': 'Self-Acceptance: This card embodies self-acceptance and embracing your true potential. The Eight of Swords reversed suggests letting go of self-defeating thoughts, cultivating self-compassion, and embracing personal freedom.',
    'reversedDescription5': 'Support: In the reversed position, the Eight of Swords represents seeking and receiving support. It signifies reaching out to others, accepting assistance, and recognizing that help is available to navigate through challenges.',
  ...
  'nine of swords': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Anxiety: The Nine of Swords upright represents intense worry, anxiety, or fear. It signifies feeling overwhelmed by negative thoughts, insomnia, or mental anguish.',
    'uprightDescription2': 'Guilt: This card embodies guilt or remorse. The Nine of Swords signifies dwelling on past mistakes, self-blame, or being consumed by a sense of wrongdoing.',
    'uprightDescription3': 'Nightmares: The Nine of Swords upright symbolizes nightmares or unsettling dreams. It represents the impact of subconscious fears, unresolved issues, or psychological distress.',
    'uprightDescription4': 'Overthinking: This card represents overthinking or excessive mental activity. The Nine of Swords signifies a racing mind, repetitive thoughts, or getting caught in a cycle of negative thinking.',
    'uprightDescription5': 'Burden: The Nine of Swords embodies a heavy emotional burden or feeling weighed down by worries. It signifies the need to address and release emotional pain, seeking support, or finding healthy coping mechanisms.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Release: The Nine of Swords reversed suggests releasing worry and finding relief from mental distress. It signifies letting go of negative thought patterns, seeking therapy or counseling, and actively working towards healing.',
    'reversedDescription2': 'Perspective: This card represents gaining a new perspective or shifting your perception. The Nine of Swords reversed signifies seeing problems in a different light, finding silver linings, or realizing that things are not as dire as they seem.',
    'reversedDescription3': 'Inner Peace: The Nine of Swords in reverse symbolizes finding inner peace and calm. It signifies practicing self-care, mindfulness, and nurturing a positive mindset to alleviate anxiety and promote emotional well-being.',
    'reversedDescription4': 'Restful Sleep: This card embodies restful sleep or improved sleep patterns. The Nine of Swords reversed suggests creating a peaceful bedtime routine, implementing relaxation techniques, or addressing any underlying causes of sleep disturbances.',
    'reversedDescription5': 'Self-Compassion: In the reversed position, the Nine of Swords represents practicing self-compassion and self-care. It signifies being gentle with yourself, seeking support from loved ones, and prioritizing mental and emotional well-being.',
  ...
  'ten of swords': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Betrayal: The Ten of Swords upright represents betrayal, backstabbing, or a sense of being deeply hurt by someyour actions. It signifies the culmination of a difficult situation or the ending of a painful cycle.',
    'uprightDescription2': 'Defeat: This card embodies defeat or a sense of overwhelming loss. The Ten of Swords signifies hitting rock bottom, experiencing a complete breakdown, or feeling utterly defeated.',
    'uprightDescription3': 'Pain: The Ten of Swords upright symbolizes physical or emotional pain. It represents suffering, anguish, or the aftermath of a devastating event that leaves one feeling wounded.',
    'uprightDescription4': 'Endings: This card represents endings or the conclusion of a chapter. The Ten of Swords signifies the need to let go, accept what cannot be changed, and make way for new beginnings.',
    'uprightDescription5': 'Transformation: The Ten of Swords embodies transformation or the potential for growth through adversity. It signifies the opportunity to rise from the ashes, learn from past experiences, and emerge stronger and wiser.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Recovery: The Ten of Swords reversed suggests the beginning of the healing process and recovery from a difficult situation. It signifies finding the strength to move forward, seeking support, and regaining a sense of hope.',
    'reversedDescription2': 'Resilience: This card represents resilience or the ability to bounce back from adversity. The Ten of Swords reversed signifies the inner strength and determination to rise above challenges and overcome obstacles.',
    'reversedDescription3': 'Release: The Ten of Swords in reverse symbolizes releasing pain and letting go of past hurts. It signifies forgiving yourself or others, finding closure, and embracing the opportunity for emotional healing.',
    'reversedDescription4': 'Renewal: This card embodies renewal or the chance for a fresh start. The Ten of Swords reversed suggests leaving behind old patterns, embracing positive change, and creating a new vision for the future.',
    'reversedDescription5': 'Recovery: In the reversed position, the Ten of Swords represents the process of recovery and rebuilding. It signifies finding support, seeking professional help if needed, and taking small steps towards regaining your strength and well-being.',
  ...
  'page of swords': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Curiosity: The Page of Swords upright represents curiosity, inquisitiveness, and a thirst for knowledge. It signifies a keen interest in learning, exploring new ideas, and seeking intellectual stimulation.',
    'uprightDescription2': 'Mental Agility: This card embodies mental agility and quick thinking. The Page of Swords signifies being mentally alert, adaptable, and able to analyze situations with clarity and precision.',
    'uprightDescription3': 'Communication: The Page of Swords upright symbolizes effective communication and the expression of ideas. It represents the ability to articulate thoughts, engage in meaningful conversations, and share information with clarity.',
    'uprightDescription4': 'Truth-seeking: This card represents a quest for truth and a desire for honesty and transparency. The Page of Swords signifies the willingness to ask challenging questions, challenge conventional wisdom, and pursue truth and justice.',
    'uprightDescription5': 'Vigilance: The Page of Swords embodies vigilance and being watchful for potential risks or threats. It signifies being cautious, staying alert, and being prepared to take action when necessary.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Impulsiveness: The Page of Swords reversed suggests impulsiveness or acting without considering the consequences. It signifies a tendency to rush into decisions or speak without thinking, leading to potential misunderstandings or conflicts.',
    'reversedDescription2': 'Dishonesty: This card represents deceit or dishonesty. The Page of Swords reversed signifies the presence of falsehoods, manipulation, or hidden agendas. It suggests being cautious of misinformation and being discerning in communication.',
    'reversedDescription3': 'Lack of Focus: The Page of Swords in reverse symbolizes a lack of focus or scattered energy. It signifies difficulty concentrating, feeling easily distracted, or struggling to follow through on commitments or tasks.',
    'reversedDescription4': 'Miscommunication: This card embodies miscommunication or misunderstandings. The Page of Swords reversed signifies the potential for communication breakdowns, conflicts arising from unclear or misinterpreted messages, or difficulty conveying thoughts effectively.',
    'reversedDescription5': 'Recklessness: In the reversed position, the Page of Swords represents recklessness or taking unnecessary risks. It signifies a disregard for consequences, impulsive actions, or engaging in behaviors that may lead to negative outcomes.',
  ...
  'knight of swords': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Ambition: The Knight of Swords upright represents ambition, drive, and a determined pursuit of goals. It signifies a relentless desire for success, taking bold action, and pushing forward with determination.',
    'uprightDescription2': 'Action: This card embodies swift and decisive action. The Knight of Swords signifies a readiness to tackle challenges, seize opportunities, and make progress towards objectives with a focused and proactive approach.',
    'uprightDescription3': 'Courage: The Knight of Swords upright symbolizes courage and fearlessness. It represents the willingness to face obstacles head-on, confront difficult situations, and take calculated risks in pursuit of your aspirations.',
    'uprightDescription4': 'Intellectual: This card represents intellectual prowess and sharp thinking. The Knight of Swords signifies a quick and analytical mind, logical reasoning, and the ability to swiftly process information to make informed decisions.',
    'uprightDescription5': 'Assertiveness: The Knight of Swords embodies assertiveness and speaking your truth. It signifies expressing opinions confidently, advocating for yourself and others, and asserting personal boundaries with clarity and conviction.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Impatience: The Knight of Swords reversed suggests impatience or a tendency to rush into action without proper planning or consideration. It signifies a need to slow down, exercise patience, and evaluate situations before making decisions.',
    'reversedDescription2': 'Aggression: This card represents aggression or a confrontational approach. The Knight of Swords reversed signifies a tendency towards hostility, conflict, or engaging in unnecessary arguments or power struggles.',
    'reversedDescription3': 'Impulsiveness: The Knight of Swords in reverse symbolizes impulsiveness and acting without forethought. It signifies making hasty decisions, lacking a strategic approach, or engaging in reckless behaviors that may lead to negative outcomes.',
    'reversedDescription4': 'Lack of Direction: This card embodies a lack of direction or purpose. The Knight of Swords reversed signifies feeling lost or uncertain about your path, experiencing a lack of clarity, or struggling to find a clear sense of direction.',
    'reversedDescription5': 'Careless: In the reversed position, the Knight of Swords represents carelessness or a disregard for consequences. It signifies acting without considering the potential impact on yourself or others, taking unnecessary risks, or being negligent in your actions.',
  ...
  'queen of swords': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Wisdom: The Queen of Swords upright represents wisdom, intelligence, and a sharp intellect. It signifies the ability to think critically, make sound judgments, and offer insightful advice.',
    'uprightDescription2': 'Clarity: This card embodies clarity of thought and perception. The Queen of Swords signifies seeing situations with objectivity, cutting through illusions, and gaining a clear understanding of the truth.',
    'uprightDescription3': 'Independence: The Queen of Swords upright symbolizes independence and self-reliance. It represents the ability to stand strong on your own, make decisions with confidence, and assert personal boundaries.',
    'uprightDescription4': 'Honesty: This card represents honesty and straightforward communication. The Queen of Swords signifies speaking the truth, even when it may be uncomfortable, and valuing honesty and integrity in relationships and interactions.',
    'uprightDescription5': 'Resilience: The Queen of Swords embodies resilience and inner strength. It signifies the ability to overcome challenges, adapt to difficult circumstances, and maintain a composed and rational demeanor in the face of adversity.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Coldness: The Queen of Swords reversed suggests a cold or aloof demeanor. It signifies a lack of emotional warmth or empathy, prioritizing logic over emotions, or distancing yourself from emotional connections.',
    'reversedDescription2': 'Manipulation: This card represents manipulation or using intellect and communication skills for personal gain. The Queen of Swords reversed signifies employing cunning tactics, deceit, or manipulation to achieve desired outcomes.',
    'reversedDescription3': 'Harshness: The Queen of Swords in reverse symbolizes harshness in speech or actions. It signifies using words as weapons, being overly critical or judgmental, or hurting others with sharp and cutting remarks.',
    'reversedDescription4': 'Closed-mindedness: This card embodies closed-mindedness or a refusal to consider different perspectives. The Queen of Swords reversed signifies being rigid in your beliefs, dismissing alternative viewpoints, or being resistant to change.',
    'reversedDescription5': 'Isolation: In the reversed position, the Queen of Swords represents isolation or withdrawing from social connections. It signifies creating emotional barriers, choosing solitude over interaction, or feeling disconnected from others.',
  ...
  'king of swords': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Authority: The King of Swords upright represents authority, leadership, and the ability to make fair and just decisions. It signifies a position of power, command, and the capacity to lead with wisdom and integrity.',
    'uprightDescription2': 'Intellect: This card embodies intellectual prowess and analytical thinking. The King of Swords signifies a sharp and keen mind, strategic planning, and the ability to assess situations with logic and reason.',
    'uprightDescription3': 'Clarity: The King of Swords upright symbolizes clarity of thought and communication. It represents the ability to express yourself clearly, articulate ideas effectively, and communicate with precision and coherence.',
    'uprightDescription4': 'Fairness: This card represents fairness, objectivity, and impartiality. The King of Swords signifies a commitment to justice, making decisions based on logic and evidence, and treating others with fairness and equity.',
    'uprightDescription5': 'Discipline: The King of Swords embodies discipline and self-control. It signifies the ability to stay focused, adhere to principles and values, and maintain a sense of responsibility and order.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Tyranny: The King of Swords reversed suggests a tyrannical or oppressive nature. It signifies abusing power, enforcing strict rules without empathy, or using authority to manipulate or control others.',
    'reversedDescription2': 'Manipulation: This card represents manipulation or using intellectual prowess for personal gain. The King of Swords reversed signifies employing deceptive tactics, twisting information, or using knowledge as a means of control.',
    'reversedDescription3': 'Dictatorship: The King of Swords in reverse symbolizes a dictatorial or autocratic approach. It signifies imposing rigid rules, suppressing dissenting voices, or refusing to consider alternative viewpoints.',
    'reversedDescription4': 'Unyielding: This card embodies inflexibility and an unwillingness to compromise. The King of Swords reversed signifies being stubborn, resistant to change, or refusing to consider different perspectives.',
    'reversedDescription5': 'Abusive: In the reversed position, the King of Swords represents abusive behavior or verbal aggression. It signifies using words as weapons, belittling others, or engaging in verbal attacks to assert dominance or superiority.',
  ...
  'ace of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Abundance: The Ace of Pentacles upright represents abundance, prosperity, and material blessings. It signifies the potential for financial stability, growth, and opportunities for material success.',
    'uprightDescription2': 'Manifestation: This card embodies the power of manifestation and the ability to turn ideas into tangible results. The Ace of Pentacles signifies the beginning of a new venture or project with great potential for materialization.',
    'uprightDescription3': 'Opportunity: The Ace of Pentacles upright symbolizes new opportunities and the promise of a fresh start. It signifies a fertile ground for growth, new business ventures, or the possibility of financial gain.',
    'uprightDescription4': 'Stability: This card represents stability and a solid foundation. The Ace of Pentacles signifies a secure and reliable environment, financial security, and a strong sense of grounding.',
    'uprightDescription5': 'Prosperity: The Ace of Pentacles embodies prosperity and wealth. It signifies the potential for financial abundance, material well-being, and the enjoyment of the fruits of your labor.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Missed opportunity: The Ace of Pentacles reversed suggests a missed or overlooked opportunity for financial gain or material success. It signifies a failure to recognize or capitalize on potential prospects.',
    'reversedDescription2': 'Financial setbacks: This card represents financial setbacks or obstacles. The Ace of Pentacles reversed signifies financial instability, unexpected expenses, or a temporary decline in material resources.',
    'reversedDescription3': 'Lack of abundance: The Ace of Pentacles in reverse symbolizes a lack of abundance or scarcity mindset. It signifies a feeling of limitation, financial struggles, or a sense of not having enough resources.',
    'reversedDescription4': 'Delayed manifestation: This card embodies a delay in the manifestation of material goals or projects. The Ace of Pentacles reversed signifies a need for patience and persistence in order to see tangible results.',
    'reversedDescription5': 'Instability: In the reversed position, the Ace of Pentacles represents instability or an insecure foundation. It signifies a lack of solid ground, financial insecurity, or an unstable environment that hinders growth and prosperity.',
  ...
  'two of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Balance: The Two of Pentacles upright represents balance and juggling multiple responsibilities or priorities. It signifies the need to find harmony and equilibrium in managing various aspects of life.',
    'uprightDescription2': 'Adaptability: This card embodies adaptability and flexibility. The Two of Pentacles signifies being able to navigate through changing circumstances, multitasking, and adjusting to different demands or situations.',
    'uprightDescription3': 'Time management: This card represents effective time management and organizational skills. The Two of Pentacles signifies the ability to prioritize tasks, allocate resources efficiently, and maintain a sense of order and structure.',
    'uprightDescription4': 'Decision-making: This card signifies decision-making and weighing options. The Two of Pentacles upright represents the need to make choices and find practical solutions while considering the potential impact on different areas of life.',
    'uprightDescription5': 'Flow: The Two of Pentacles embodies the concept of flow and going with the rhythm of life. It signifies embracing change, staying adaptable, and finding a sense of ease and grace in managing various responsibilities.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Imbalance: The Two of Pentacles reversed suggests an imbalance or difficulty in managing conflicting priorities or responsibilities. It signifies a lack of harmony or struggling to find equilibrium in various areas of life.',
    'reversedDescription2': 'Overwhelm: This card represents feeling overwhelmed or burdened by the demands and obligations of life. The Two of Pentacles reversed signifies a sense of being stretched too thin or struggling to keep up with multiple tasks.',
    'reversedDescription3': 'Poor time management: This card signifies poor time management or disorganization. The Two of Pentacles in reverse represents difficulties in prioritizing tasks, managing time effectively, or maintaining a sense of order.',
    'reversedDescription4': 'Lack of adaptability: This card embodies a lack of adaptability or resistance to change. The Two of Pentacles reversed signifies difficulties in adjusting to new circumstances, being rigid in mindset, or struggling with transitions.',
    'reversedDescription5': 'Unresolved conflicts: In the reversed position, the Two of Pentacles represents unresolved conflicts or tensions between different areas of life. It signifies challenges in finding a harmonious balance and addressing competing priorities.',
  ...
  'three of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Collaboration: The Three of Pentacles upright represents collaboration, teamwork, and collective efforts. It signifies the successful combination of skills, talents, and resources to achieve a common goal.',
    'uprightDescription2': 'Skill development: This card embodies skill development and mastery. The Three of Pentacles signifies the need for continuous learning, honing your abilities, and striving for excellence in a specific area.',
    'uprightDescription3': 'Recognition: This card represents recognition and appreciation for your work and contributions. The Three of Pentacles signifies receiving acknowledgment, praise, or rewards for the effort and quality of work.',
    'uprightDescription4': 'Planning: The Three of Pentacles upright signifies careful planning and attention to detail. It represents the need to create a solid foundation, set clear goals, and follow a structured approach to achieve success.',
    'uprightDescription5': 'Progress: This card embodies progress and forward momentum. The Three of Pentacles signifies making tangible strides, achieving milestones, and witnessing the gradual manifestation of efforts.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Lack of collaboration: The Three of Pentacles reversed suggests a lack of collaboration or difficulties in working together effectively. It signifies challenges in coordinating efforts, miscommunication, or a lack of synergy among team members.',
    'reversedDescription2': 'Skill gaps: This card represents skill gaps or limitations in your abilities. The Three of Pentacles reversed signifies the need for further development, refining skills, or addressing areas of weakness.',
    'reversedDescription3': 'Unrecognized efforts: This card signifies a lack of recognition or appreciation for your work. The Three of Pentacles in reverse suggests feeling undervalued, overlooked, or not receiving the deserved recognition for contributions.',
    'reversedDescription4': 'Lack of planning: The Three of Pentacles reversed embodies a lack of planning or disorganized approach. It signifies a need for more structure, clarity in goals, or a failure to follow a strategic path towards success.',
    'reversedDescription5': 'Stagnation: In the reversed position, the Three of Pentacles represents stagnation or lack of progress. It signifies feeling stuck, experiencing delays, or a lack of forward movement in projects or endeavors.',
  ...
  'four of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Stability: The Four of Pentacles upright represents stability and security. It signifies a sense of financial or material stability, as well as an emphasis on preserving resources and maintaining control over your possessions.',
    'uprightDescription2': 'Possessiveness: This card embodies possessiveness or a strong attachment to material possessions. The Four of Pentacles signifies a need for control, holding tightly onto resources, and being cautious about letting go.',
    'uprightDescription3': 'Prudence: The Four of Pentacles represents prudence and careful financial management. It signifies the importance of budgeting, saving, and making practical decisions to maintain a stable financial foundation.',
    'uprightDescription4': 'Boundaries: This card signifies setting boundaries and protecting your interests. The Four of Pentacles upright represents establishing clear boundaries in relationships, finances, or personal space to maintain a sense of security.',
    'uprightDescription5': 'Accumulation: The Four of Pentacles embodies accumulation and building wealth. It signifies the ability to gather and accumulate resources over time, leading to a sense of abundance and financial well-being.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Financial insecurity: The Four of Pentacles reversed suggests financial insecurity or instability. It signifies a fear of loss, inability to hold onto resources, or difficulties in managing finances effectively.',
    'reversedDescription2': 'Greed: This card represents greed or an excessive attachment to material possessions. The Four of Pentacles reversed signifies a hoarding mentality, an insatiable desire for more, or a reluctance to share resources with others.',
    'reversedDescription3': 'Financial mismanagement: The Four of Pentacles in reverse signifies poor financial management or overspending. It represents a lack of control over finances, reckless spending, or ignoring the importance of saving and budgeting.',
    'reversedDescription4': 'Letting go: This card embodies the need to let go and release attachment to material possessions. The Four of Pentacles reversed signifies the importance of finding a balance between holding onto resources and being willing to share or invest in meaningful experiences.',
    'reversedDescription5': 'Generosity: In the reversed position, the Four of Pentacles represents a call for generosity and giving. It signifies the importance of sharing resources, contributing to others, or finding fulfillment through acts of kindness and charity.',
  ...
  'five of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Hardship: The Five of Pentacles upright represents hardship and challenges. It signifies financial struggles, adversity, or a sense of lack and scarcity in your life.',
    'uprightDescription2': 'Isolation: This card embodies feelings of isolation or being left out. The Five of Pentacles signifies a sense of being excluded, disconnected, or lacking support during difficult times.',
    'uprightDescription3': 'Resilience: The Five of Pentacles represents resilience and the ability to persevere in the face of adversity. It signifies finding inner strength, seeking alternative solutions, and overcoming obstacles despite the challenges.',
    'uprightDescription4': '  Resourcefulness: This card signifies resourcefulness and making the most of limited resources. The Five of Pentacles upright encourages finding creative solutions, seeking help from others, or utilizing available assets to navigate difficult circumstances.',
    'uprightDescription5': 'Seeking assistance: The Five of Pentacles embodies the need to seek assistance or support during challenging times. It encourages reaching out for help, whether it be financial, emotional, or practical, to alleviate the burden.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Recovery: The Five of Pentacles reversed suggests a gradual recovery from hardship or financial difficulties. It signifies a turning point, where positive changes or assistance start to alleviate the struggles and offer hope for a better future.',
    'reversedDescription2': 'Support: This card represents receiving support or help from others. The Five of Pentacles reversed signifies finding assistance, community, or renewed connections that provide comfort and aid during tough times.',
    'reversedDescription3': 'Resilience: The Five of Pentacles in reverse embodies resilience and bouncing back from adversity. It signifies inner strength, learning from past experiences, and using setbacks as fuel for personal growth and transformation.',
    'reversedDescription4': 'Overcoming challenges: This card signifies the ability to overcome challenges and rise above difficult circumstances. The Five of Pentacles reversed encourages finding alternative paths, embracing opportunities, or making positive changes to improve your situation.',
    'reversedDescription5': 'Self-reliance: In the reversed position, the Five of Pentacles represents developing self-reliance and taking steps towards independence. It signifies finding inner resources, building resilience, and taking control of your own destiny.',
  ...
  'six of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Generosity: The Six of Pentacles upright represents generosity and giving. It signifies a willingness to share resources, wealth, or support with others who are in need.',
    'uprightDescription2': 'Charity: This card embodies acts of charity and philanthropy. The Six of Pentacles signifies a compassionate nature, a desire to make a positive difference in the lives of others, and a sense of social responsibility.',
    'uprightDescription3': 'Fairness: The Six of Pentacles represents fairness and balance in giving and receiving. It signifies the importance of equitable distribution, treating others with equality and respect, and honoring reciprocal exchanges.',
    'uprightDescription4': 'Abundance: This card signifies abundance and prosperity. The Six of Pentacles upright represents a sense of financial stability, the ability to meet your needs, and experiencing the rewards of hard work and generosity.',
    'uprightDescription5': 'Assistance: The Six of Pentacles embodies offering and receiving assistance. It signifies being open to both giving and receiving help, fostering a supportive community, and recognizing the value of interdependence.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Selfishness: The Six of Pentacles reversed suggests selfishness or a lack of generosity. It signifies a reluctance to share resources, hoarding wealth, or prioritizing your own needs at the expense of others.',
    'reversedDescription2': 'Inequality: This card represents inequality or unfair distribution of resources. The Six of Pentacles reversed signifies a lack of balance in giving and receiving, favoritism, or a disregard for the needs of others.',
    'reversedDescription3': 'Financial instability: The Six of Pentacles in reverse signifies financial instability or a struggle to meet your own needs. It may indicate a lack of resources, dependence on others, or difficulties in managing finances effectively.',
    'reversedDescription4': 'Greed: This card embodies greed or an excessive focus on material wealth. The Six of Pentacles reversed signifies a self-centered approach, pursuing personal gain at the expense of others, or an insatiable desire for more.',
    'reversedDescription5': 'Lack of support: In the reversed position, the Six of Pentacles represents a lack of support or assistance. It may indicate a scarcity of resources, feeling unsupported in times of need, or a reluctance to seek or accept help from others.',
  ...
  'seven of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Assessment: The Seven of Pentacles upright represents assessment and evaluation. It signifies taking a step back to review progress, outcomes, or investments and considering future strategies or adjustments.',
    'uprightDescription2': 'Patience: This card embodies patience and delayed gratification. The Seven of Pentacles signifies the need to wait for results or rewards, trusting in the process, and maintaining persistence despite temporary setbacks.',
    'uprightDescription3': 'Growth: The Seven of Pentacles represents growth and development. It signifies the progress made through consistent effort, nurturing projects or investments, and seeing the gradual but steady results of hard work.',
    'uprightDescription4': 'Reflection: This card signifies reflection and introspection. The Seven of Pentacles upright encourages self-reflection, analyzing past experiences, and gaining insights that can inform future decisions or actions.',
    'uprightDescription5': 'Harvest: The Seven of Pentacles embodies reaping the rewards of your efforts. It signifies the satisfaction of seeing tangible results, enjoying the fruits of labor, and experiencing the fulfillment that comes from a job well done.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Impatience: The Seven of Pentacles reversed suggests impatience or a desire for immediate results. It signifies a lack of willingness to wait or invest long-term effort, seeking quick fixes or shortcuts instead.',
    'reversedDescription2': 'Frustration: This card represents frustration or disappointment with the progress or outcomes. The Seven of Pentacles reversed signifies feeling discouraged, questioning the worth of investments or efforts, or experiencing delays and setbacks.',
    'reversedDescription3': 'Lack of growth: The Seven of Pentacles in reverse signifies a lack of growth or stagnation. It may indicate a lack of progress, a failure to see desired results, or a sense of being stuck in a rut.',
    'reversedDescription4': 'Impulsive decisions: This card embodies impulsive decisions or a lack of thoughtful planning. The Seven of Pentacles reversed signifies making hasty choices without considering long-term consequences or failing to assess risks adequately.',
    'reversedDescription5': 'Poor investments: In the reversed position, the Seven of Pentacles represents poor investments or a lack of return on investment. It may indicate wasted time, energy, or resources on endeavors that do not yield satisfactory results.',
  ...
  'eight of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Diligence: The Eight of Pentacles upright represents diligence and hard work. It signifies a strong work ethic, attention to detail, and a commitment to honing skills or mastering a craft.',
    'uprightDescription2': 'Skill development: This card embodies skill development and craftsmanship. The Eight of Pentacles signifies a focus on learning, improvement, and acquiring expertise in a particular area of interest or profession.',
    'uprightDescription3': 'Dedication: The Eight of Pentacles represents dedication and commitment to a task or goal. It signifies the willingness to put in the necessary time and effort, displaying persistence and discipline in pursuit of excellence.',
    'uprightDescription4': 'Productivity: This card signifies productivity and efficiency. The Eight of Pentacles upright represents being focused and productive, managing tasks effectively, and accomplishing goals with precision and consistency.',
    'uprightDescription5': 'Mastery: The Eight of Pentacles embodies mastery and expertise. It signifies reaching a high level of proficiency, achieving mastery in a specific domain, and feeling a sense of accomplishment and fulfillment in your work.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Lack of focus: The Eight of Pentacles reversed suggests a lack of focus or commitment. It signifies difficulty in staying dedicated to a task or project, being easily distracted, or lacking the motivation to put in consistent effort.',
    'reversedDescription2': 'Mediocrity: This card represents mediocrity or subpar work. The Eight of Pentacles reversed signifies a lack of attention to detail, producing work that falls short of expectations, or settling for average performance.',
    'reversedDescription3': 'Skill gaps: The Eight of Pentacles in reverse signifies gaps in skills or knowledge. It may indicate a need for further development or improvement, encountering challenges in learning new skills, or feeling inadequate in comparison to others.',
    'reversedDescription4': 'Burnout: This card embodies burnout or exhaustion. The Eight of Pentacles reversed signifies feeling overwhelmed by work, losing passion or motivation, or experiencing a decline in productivity due to mental or physical fatigue.',
    'reversedDescription5': 'Lack of progress: In the reversed position, the Eight of Pentacles represents a lack of progress or stagnation. It may indicate feeling stuck in a routine, unable to advance or grow professionally, or struggling to see tangible results from efforts.',
  ...
  'nine of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Abundance: The Nine of Pentacles upright represents abundance and prosperity. It signifies enjoying the rewards of hard work, financial stability, and a comfortable lifestyle.',
    'uprightDescription2': 'Independence: This card embodies independence and self-sufficiency. The Nine of Pentacles signifies having the resources and freedom to enjoy life on your terms, being self-reliant, and experiencing a sense of personal autonomy.',
    'uprightDescription3': 'Luxury: The Nine of Pentacles represents luxury and refinement. It signifies indulging in the finer things in life, appreciating beauty, and surrounding yourself with comfort and elegance.',
    'uprightDescription4': 'Gratitude: This card signifies gratitude and appreciation. The Nine of Pentacles upright encourages recognizing and expressing gratitude for the blessings, accomplishments, and abundance in your life.',
    'uprightDescription5': 'Self-care: The Nine of Pentacles embodies self-care and personal well-being. It signifies taking care of yourself, prioritizing leisure and relaxation, and nurturing a balanced and fulfilling lifestyle.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Financial setbacks: The Nine of Pentacles reversed suggests financial setbacks or instability. It signifies experiencing financial difficulties, setbacks, or a loss of wealth and abundance.',
    'reversedDescription2': 'Dependence: This card represents dependence or relying on others for financial or emotional support. The Nine of Pentacles reversed signifies a loss of independence, feeling financially constrained, or experiencing a lack of personal freedom.',
    'reversedDescription3': 'Materialism: The Nine of Pentacles in reverse embodies excessive materialism or a focus on superficial values. It may indicate prioritizing material possessions over deeper fulfillment, feeling empty despite material wealth, or being consumed by a desire for more.',
    'reversedDescription4': 'Isolation: This card signifies feelings of isolation or loneliness. The Nine of Pentacles reversed represents a lack of social connection, feeling disconnected from others, or experiencing a sense of emptiness despite external success.',
    'reversedDescription5': 'Imbalance: In the reversed position, the Nine of Pentacles represents imbalance or an imbalance in work-life harmony. It may indicate neglecting personal well-being, being consumed by work or material pursuits, or struggling to find fulfillment beyond external achievements.',
  ...
  'ten of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Legacy: The Ten of Pentacles upright represents a solid foundation and the creation of a lasting legacy. It signifies the culmination of long-term efforts, financial security, and the ability to leave a positive impact for future generations.',
    'uprightDescription2': 'Prosperity: This card embodies abundance and prosperity on all levels. The Ten of Pentacles signifies financial wealth, material stability, and a comfortable lifestyle that provides for both immediate and future needs.',
    'uprightDescription3': 'Family: The Ten of Pentacles represents strong family bonds and the importance of familial connections. It signifies a harmonious and supportive family environment, generational wealth, and the passing down of traditions and values.',
    'uprightDescription4': 'Stability: This card signifies stability and security in all areas of life. The Ten of Pentacles upright represents a solid and reliable foundation, long-term success, and a sense of grounding and stability.',
    'uprightDescription5': 'Fulfillment: The Ten of Pentacles embodies a sense of fulfillment and contentment. It signifies achieving personal and material goals, experiencing deep satisfaction, and finding joy and meaning in life\'s accomplishments.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Financial loss: The Ten of Pentacles reversed suggests financial loss or instability. It signifies a potential setback in finances, unexpected expenses, or the loss of a source of income or wealth.',
    'reversedDescription2': 'Disconnection: This card represents disconnection or disharmony within family or community. The Ten of Pentacles reversed signifies family disputes, estrangement, or a breakdown in relationships, leading to a sense of disconnection and alienation.',
    'reversedDescription3': 'Instability: The reversed Ten of Pentacles embodies instability and lack of security. It may indicate a lack of financial stability, uncertainty about the future, or a feeling of being uprooted or unsettled in your circumstances.',
    'reversedDescription4': 'Inheritance issues: This card signifies potential issues or conflicts related to inheritance or family wealth. The Ten of Pentacles reversed may suggest disputes over inheritance, legal complications, or challenges related to managing family assets.',
    'reversedDescription5': 'Lack of fulfillment: In the reversed position, the Ten of Pentacles represents a lack of fulfillment or dissatisfaction despite external success. It may indicate that material wealth alone is not bringing deep fulfillment, leaving a sense of emptiness or discontent.',
  ...
  'page of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Ambition: The Page of Pentacles upright represents a strong drive and ambition to achieve your goals. It signifies a focus on practical matters, a willingness to learn and grow, and the determination to make steady progress towards success.',
    'uprightDescription2': 'Opportunity: This card embodies the presence of new opportunities and the potential for growth. The Page of Pentacles signifies being open to new experiences, ventures, or learning opportunities that can lead to material and personal advancement.',
    'uprightDescription3': 'Study: The Page of Pentacles represents a studious and curious nature. It signifies the pursuit of knowledge, education, or skill development. It encourages a disciplined approach to learning and acquiring practical skills that can contribute to future success.',
    'uprightDescription4': 'Practicality: This card embodies a practical and down-to-earth approach to life. The Page of Pentacles signifies a focus on practical matters, financial responsibility, and making grounded decisions that lead to long-term stability and security.',
    'uprightDescription5': 'Patience: The Page of Pentacles encourages patience and perseverance. It signifies the need to take a step-by-step approach, to be diligent and attentive to detail, and to understand that success takes time and effort.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Lack of focus: The reversed Page of Pentacles suggests a lack of focus or direction. It signifies scattered energy, difficulty in finding a sense of purpose, or being easily distracted by superficial matters.',
    'reversedDescription2': 'Missed opportunities: This card represents missed or overlooked opportunities. The reversed Page of Pentacles signifies a failure to recognize or capitalize on potential opportunities for growth or advancement.',
    'reversedDescription3': 'Procrastination: This card embodies a tendency to procrastinate or delay action. The reversed Page of Pentacles suggests a lack of motivation or discipline, resulting in missed deadlines, unfinished projects, or a failure to follow through on commitments.',
    'reversedDescription4': 'Impracticality: This card signifies a lack of practicality or realism. The reversed Page of Pentacles suggests a tendency to be unrealistic, impulsive, or overly idealistic in your approach to practical matters or decision-making.',
    'reversedDescription5': 'Lack of progress: In the reversed position, the Page of Pentacles represents a lack of progress or stagnation. It may indicate feeling stuck or unable to move forward, encountering obstacles or setbacks in achieving goals, or a lack of growth and development.',
  ...
  'knight of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Responsibility: The Knight of Pentacles upright embodies a strong sense of responsibility and reliability. It signifies a dedicated and diligent approach to work, a commitment to fulfilling obligations, and a focus on long-term stability and success.',
    'uprightDescription2': 'Hard work: This card represents a strong work ethic and a willingness to put in the effort required to achieve goals. The Knight of Pentacles signifies a methodical and disciplined approach to tasks, a commitment to quality and craftsmanship, and a focus on practicality and tangible results.',
    'uprightDescription3': 'Patience: The Knight of Pentacles encourages patience and perseverance. It signifies the ability to stay focused and dedicated, even when faced with challenges or delays. It reminds you to take a steady and measured approach, knowing that consistent effort will lead to eventual success.',
    'uprightDescription4': 'Reliability: This card embodies dependability and trustworthiness. The Knight of Pentacles signifies being someone others can rely on, fulfilling commitments, and honoring responsibilities. It represents a strong and stable presence in both personal and professional relationships.',
    'uprightDescription5': 'Practicality: The Knight of Pentacles embodies a practical and grounded nature. It signifies making well-thought-out decisions, taking a conservative approach to finances, and focusing on tangible results and material stability.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Laziness: The reversed Knight of Pentacles suggests a lack of motivation or a tendency to be lazy or unmotivated. It signifies a lack of drive or commitment to fulfilling responsibilities or accomplishing tasks.',
    'reversedDescription2': 'Procrastination: This card represents a tendency to procrastinate or delay action. The reversed Knight of Pentacles signifies a lack of focus or discipline, resulting in missed deadlines, unfinished projects, or a failure to follow through on commitments.',
    'reversedDescription3': 'Inflexibility: This card embodies rigidity and resistance to change. The reversed Knight of Pentacles suggests being overly stubborn or resistant to new ideas or perspectives, which can hinder personal or professional growth.',
    'reversedDescription4': 'Impatience: The reversed Knight of Pentacles signifies a lack of patience or a desire for quick results. It may indicate a tendency to rush through tasks or projects without paying attention to detail, leading to errors or subpar outcomes.',
    'reversedDescription5': 'Financial instability: In the reversed position, the Knight of Pentacles represents potential financial instability or mismanagement. It suggests a need to reassess financial decisions and adopt a more responsible and cautious approach to money matters.',
  ...
  'queen of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Nurturing: The Queen of Pentacles upright represents a nurturing and caring nature. It signifies providing support and stability to others, creating a warm and nurturing environment, and taking care of practical and material needs.',
    'uprightDescription2': 'Abundance: This card embodies a sense of abundance and prosperity. The Queen of Pentacles signifies financial stability, material comfort, and an appreciation for the physical world. It represents a practical and grounded approach to money and resources.',
    'uprightDescription3': 'Practicality: The Queen of Pentacles embodies practicality and resourcefulness. It signifies finding practical solutions to problems, managing resources effectively, and making decisions based on practical considerations. It represents a down-to-earth and sensible approach to life.',
    'uprightDescription4': 'Sensuality: This card represents an appreciation for sensual pleasures and physical experiences. The Queen of Pentacles signifies a connection with the senses, enjoying the beauty of nature, and finding joy in the physical aspects of life.',
    'uprightDescription5': 'Nurturing relationships: The Queen of Pentacles signifies a focus on building and nurturing relationships. It represents being supportive, caring, and dependable in personal relationships, and creating a loving and harmonious home environment.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Financial instability: The reversed Queen of Pentacles suggests potential financial instability or mismanagement. It signifies a need to reassess financial decisions, be cautious with money, and avoid excessive materialism or overspending.',
    'reversedDescription2': 'Neglect: This card represents a tendency to neglect practical matters or responsibilities. The reversed Queen of Pentacles signifies a lack of attention to detail, disorganization, or neglecting self-care and personal well-being.',
    'reversedDescription3': 'Overindulgence: The reversed Queen of Pentacles signifies a tendency to overindulge or seek comfort in material possessions or sensory pleasures. It may indicate a lack of moderation or an excessive focus on material wealth and possessions.',
    'reversedDescription4': 'Dependency: This card embodies a potential reliance on others for support or a lack of independence. The reversed Queen of Pentacles suggests a need to develop self-sufficiency and take responsibility for your own needs and resources.',
    'reversedDescription5': 'Imbalance: In the reversed position, the Queen of Pentacles represents a lack of balance between practicality and nurturing. It may indicate a tendency to prioritize material needs over emotional well-being or neglecting self-care in favor of taking care of others.',
  ...
  'king of pentacles': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Leadership: The King of Pentacles upright represents strong leadership qualities. It signifies being responsible, reliable, and dependable, and taking charge of practical matters. The King of Pentacles is a symbol of stability and success.',
    'uprightDescription2': 'Wealth: This card embodies wealth and financial abundance. The King of Pentacles signifies material success, financial security, and a mastery of managing resources. It represents a practical and disciplined approach to wealth and prosperity.',
    'uprightDescription3': 'Practicality: The King of Pentacles embodies practicality and a down-to-earth nature. It signifies making decisions based on practical considerations, being grounded and reliable, and having a strong work ethic. The King of Pentacles is focused on achieving tangible results.',
    'uprightDescription4': 'Generosity: This card represents generosity and a willingness to share your resources with others. The King of Pentacles signifies a giving nature, philanthropy, and a desire to help others succeed. It represents using wealth and influence for the benefit of others.',
    'uprightDescription5': 'Mastery: The King of Pentacles symbolizes mastery in your field or expertise. It signifies a high level of skill, knowledge, and experience. The King of Pentacles represents being recognized and respected for your achievements and expertise.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Financial instability: The reversed King of Pentacles suggests potential financial instability or mismanagement. It may indicate reckless spending, poor financial decisions, or a lack of long-term planning.',
    'reversedDescription2': 'Greed: This card represents a tendency towards greed or materialism. The reversed King of Pentacles signifies a focus on accumulating wealth at the expense of other values, a reluctance to share resources, or a lack of generosity.',
    'reversedDescription3': 'Misuse of power: The reversed King of Pentacles signifies a misuse of power or authority. It may indicate manipulation, exploitation, or a lack of ethical conduct in business or personal relationships.',
    'reversedDescription4': 'Indolence: This card embodies laziness or a lack of motivation. The reversed King of Pentacles suggests a lack of ambition or drive, procrastination, or a resistance to taking action towards achieving goals.',
    'reversedDescription5': 'Financial setbacks: In the reversed position, the King of Pentacles represents potential financial setbacks or obstacles. It may indicate financial losses, difficulties in managing resources, or a need to reassess financial strategies and goals.',
  ...
  'ace of wands': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Inspiration: The Ace of Wands upright represents a surge of inspiration and creative energy. It signifies the birth of new ideas, opportunities, and potential. The Ace of Wands is a symbol of passion, enthusiasm, and motivation.',
    'uprightDescription2': 'Potential: This card embodies the potential for growth and success. The Ace of Wands signifies the beginning of a new venture or project with great potential for fulfillment and achievement. It represents the spark of potential waiting to be ignited.',
    'uprightDescription3': 'Action: The Ace of Wands is a call to take action. It signifies a time of taking bold steps, making decisive moves, and seizing opportunities. It represents a burst of energy and a willingness to pursue your passions and goals.',
    'uprightDescription4': 'Creativity: This card symbolizes creativity and originality. The Ace of Wands signifies tapping into your creative potential, exploring new ideas, and expressing yourself authentically. It represents the power of imagination and innovation.',
    'uprightDescription5': 'Confidence: The Ace of Wands embodies confidence and self-assurance. It signifies a belief in your abilities and a readiness to take on challenges. The Ace of Wands represents a strong sense of self and a willingness to step into leadership roles.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Blocked creativity: The reversed Ace of Wands suggests a blockage or inhibition of creative energy. It may indicate a lack of inspiration, creative stagnation, or feeling stuck in a creative rut.',
    'reversedDescription2': 'Missed opportunities: This card represents missed opportunities or a failure to take action. The reversed Ace of Wands signifies hesitation, indecisiveness, or a fear of taking risks. It may indicate a need to overcome self-doubt and seize the opportunities presented.',
    'reversedDescription3': 'Lack of direction: The reversed Ace of Wands signifies a lack of clarity or direction. It may indicate feeling lost or uncertain about your passions and goals. This card suggests the need to reassess and find a new sense of purpose.',
    'reversedDescription4': 'Burnout: This card embodies burnout or exhaustion. The reversed Ace of Wands suggests a depletion of energy, enthusiasm, or motivation. It may indicate the need to rest, recharge, and find a balance between work and personal life.',
    'reversedDescription5': 'Low confidence: In the reversed position, the Ace of Wands represents a lack of confidence or self-belief. It may indicate self-doubt, fear of failure, or a lack of trust in your abilities. This card suggests the need to build self-confidence and belief in your creative potential.',
  ...
  'two of wands': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Planning: The Two of Wands upright signifies strategic planning and vision. It represents the ability to envision future possibilities and make long-term plans. This card encourages taking a broader perspective and considering various options before making decisions.',
    'uprightDescription2': 'Partnership: This card symbolizes collaboration and partnerships. The Two of Wands upright represents the potential for fruitful partnerships, teamwork, and shared goals. It indicates the importance of seeking support and cooperation to achieve success.',
    'uprightDescription3': 'Expansion: The Two of Wands represents expansion and growth. It signifies stepping out of your comfort zone and exploring new horizons. This card encourages embracing opportunities for personal and professional growth.',
    'uprightDescription4': 'Confidence: This card embodies confidence and self-assurance. The Two of Wands upright signifies a belief in your abilities and a readiness to take on challenges. It represents a strong sense of self and a willingness to take the necessary steps to achieve your goals.',
    'uprightDescription5': 'Future planning: The Two of Wands upright encourages forward-thinking and future planning. It represents a time of considering long-term goals, making strategic decisions, and setting a clear direction for the future.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Lack of direction: The reversed Two of Wands suggests a lack of clarity or direction. It may indicate feeling uncertain or indecisive about the next steps to take. This card encourages reassessing goals and finding a new sense of purpose.',
    'reversedDescription2': 'Limited perspective: This card represents a limited perspective or narrow vision. The reversed Two of Wands suggests the need to broaden your horizons and consider alternative viewpoints. It may indicate a tendency to get stuck in a fixed mindset or resist change.',
    'reversedDescription3': 'Delayed plans: This card signifies delays or setbacks in plans and projects. The reversed Two of Wands suggests that progress may be slower than expected or hindered by unforeseen obstacles. Patience and adaptability are advised.',
    'reversedDescription4': 'Disconnection: The reversed Two of Wands represents a disconnection or lack of alignment with your long-term goals and aspirations. It may indicate a need to realign priorities and find a stronger sense of purpose.',
    'reversedDescription5': 'Missed opportunities: This card symbolizes missed opportunities or a failure to take action. The reversed Two of Wands suggests hesitancy, indecisiveness, or a fear of taking risks. It encourages stepping out of your comfort zone and seizing the opportunities presented.',
  ...
  'three of wands': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Expansion: The Three of Wands upright represents expansion, growth, and progress. It signifies the successful implementation of plans and the emergence of new opportunities. This card suggests stepping into a larger world and embracing new possibilities.',
    'uprightDescription2': 'Exploration: This card symbolizes exploration and adventure. The Three of Wands upright encourages venturing into uncharted territory, seeking new experiences, and broadening horizons. It represents a sense of curiosity and openness to discovering new paths.',
    'uprightDescription3': 'Collaboration: The Three of Wands signifies collaboration and teamwork. It indicates the importance of working together with others to achieve common goals. This card represents synergy and the power of collective efforts.',
    'uprightDescription4': 'Optimism: This card embodies optimism and confidence. The Three of Wands upright suggests a positive outlook and a belief in the success of your endeavors. It encourages maintaining a hopeful attitude and trusting in the journey.',
    'uprightDescription5': 'Progression: The Three of Wands signifies progression and forward movement. It represents the momentum gained through previous efforts and the anticipation of further accomplishments. This card encourages staying focused, persevering, and continuing to take steps toward goals.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Stagnation: The reversed Three of Wands suggests a lack of progress or feeling stuck in a stagnant situation. It may indicate a delay or obstacle preventing forward movement. This card encourages reassessing plans and finding ways to overcome limitations.',
    'reversedDescription2': 'Impatience: This card represents impatience or a desire for immediate results. The reversed Three of Wands suggests the need for patience and understanding that progress takes time. It encourages focusing on the present moment rather than solely on future outcomes.',
    'reversedDescription3': 'Lack of vision: The reversed Three of Wands symbolizes a lack of vision or a narrow perspective. It may indicate difficulty in seeing the bigger picture or limited awareness of available opportunities. This card encourages expanding your viewpoint and considering alternative paths.',
    'reversedDescription4': 'Misalignment: This card signifies a misalignment with goals or a lack of clarity about your direction. The reversed Three of Wands suggests the need to reassess priorities and realign with personal values and aspirations. It may involve letting go of ventures that no longer serve your growth.',
    'reversedDescription5': 'Missed opportunities: The reversed Three of Wands represents missed opportunities or a failure to seize potential prospects. It may indicate hesitation, fear of taking risks, or a tendency to overlook favorable circumstances. This card encourages being more attentive and proactive in recognizing and pursuing opportunities.',
  ...
  'four of wands': {
    ...
    'uprightDescription2': 'Harmony: This card signifies harmony and balance. The Four of Wands upright represents the harmonious integration of different aspects of life, such as work and personal relationships. It suggests creating a stable and supportive environment where everyone can thrive.',
    'uprightDescription3': 'Homecoming: The Four of Wands symbolizes homecoming and reunions. It represents a time of returning to familiar places and reconnecting with loved ones. This card signifies a sense of belonging, comfort, and security within your community or family.',
    'uprightDescription4': 'Unity: This card embodies unity and cooperation. The Four of Wands upright suggests the importance of collaboration, teamwork, and shared goals. It represents the power of coming together and working collectively towards a common vision or purpose.',
    'uprightDescription5': 'Achievement: The Four of Wands signifies achievement and success. It represents reaching a significant milestone or accomplishing a major goal. This card encourages recognizing and celebrating personal achievements while also acknowledging the support and contributions of others.',
    'upright1': 'Celebration: The Four of Wands upright represents celebration, joy, and happiness. It signifies a moment of harmony and accomplishment, often associated with special events or milestones. This card symbolizes a time of coming together, enjoying the fruits of labor, and feeling a sense of achievement.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Disruption: The reversed Four of Wands suggests a disruption or disturbance in harmony and stability. It may indicate conflicts, disagreements, or challenges that hinder the smooth flow of events. This card encourages addressing and resolving conflicts to restore balance.',
    'reversedDescription2': 'Fragmentation: This card signifies fragmentation or lack of unity. The reversed Four of Wands suggests a breakdown in teamwork, cooperation, or shared values. It may indicate the need for better communication and finding common ground to restore harmony.',
    'reversedDescription3': 'Delay: The reversed Four of Wands represents delays or setbacks in celebrations or milestones. It suggests that the desired outcomes may be postponed or require more time and effort than initially expected. This card encourages patience and persistence in the face of obstacles.',
    'reversedDescription4': 'Unfulfillment: This card symbolizes unfulfilled expectations or a sense of dissatisfaction. The reversed Four of Wands suggests that the current situation may fall short of desired outcomes or fail to bring the expected joy and fulfillment. It encourages reassessing goals and finding alternative sources of satisfaction.',
    'reversedDescription5': 'Lack of stability: The reversed Four of Wands signifies a lack of stability or an unstable foundation. It may indicate insecurity, unpredictability, or a shaky environment. This card encourages taking steps to establish a stronger and more solid base for future endeavors.',
  ...
  'five of wands': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Conflict: The Five of Wands upright represents conflict, competition, and struggle. It symbolizes challenges and obstacles that arise from differing opinions, interests, or goals. This card indicates the need for assertiveness, communication, and finding common ground amidst competing forces.',
    'uprightDescription2': 'Competition: This card signifies competition and the need to assert yourself. The Five of Wands upright suggests a competitive environment where individuals vie for attention, resources, or recognition. It encourages healthy competition that fosters growth, innovation, and the development of new skills.',
    'uprightDescription3': 'Energy: The Five of Wands embodies high energy and action. It represents a dynamic and spirited situation where everyone is actively engaged. This card signifies the vitality and enthusiasm required to tackle challenges, overcome obstacles, and pursue goals with determination.',
    'uprightDescription4': 'Collaboration: This card suggests the potential for collaboration and teamwork amidst conflicts. The Five of Wands upright encourages individuals to find ways to work together, combining your strengths and talents to overcome challenges. It emphasizes the importance of cooperation and open communication.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Internal Conflict: The reversed Five of Wands suggests internal conflict or inner turmoil. It represents conflicting desires, doubts, or confusion that hinder progress. This card encourages self-reflection and finding inner harmony to overcome personal obstacles.',
    'reversedDescription2': 'Lack of Direction: This card signifies a lack of direction or focus. The reversed Five of Wands suggests scattered energy, disorganization, or a lack of clear goals. It indicates the need to prioritize, set clear intentions, and channel energy effectively.',
    'reversedDescription3': 'Avoidance: The reversed Five of Wands represents avoiding or ignoring conflicts. It suggests a reluctance to address or confront issues, which may lead to unresolved tensions. This card encourages facing conflicts head-on and seeking resolution for long-term harmony.',
    'reversedDescription4': 'Unproductive Competition: This card symbolizes unhealthy or unproductive competition. The reversed Five of Wands suggests excessive rivalry, ego-driven conflicts, or a win-at-all-costs mentality. It encourages finding ways to collaborate and cooperate rather than engaging in destructive competition.',
    'reversedDescription5': 'Stagnation: The reversed Five of Wands signifies a lack of progress or stagnation due to ongoing conflicts. It suggests that unresolved disputes or constant battles may hinder growth and development. This card encourages finding new approaches, seeking mediation, or letting go of unnecessary conflicts to move forward.',
  ...
  'six of wands': {
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Setbacks: The reversed Six of Wands suggests setbacks, delays, or obstacles that hinder progress. It signifies temporary challenges or a lack of forward momentum. This card encourages perseverance, reassessment of goals, and finding new strategies to overcome obstacles.',
    'reversedDescription2': 'Ego Check: The reversed Six of Wands signifies a need for a reality check or humbling experience. It suggests that excessive pride, arrogance, or a sense of entitlement may be impeding progress. This card encourages humility, self-reflection, and focusing on personal growth rather than seeking external validation.',
    'reversedDescription3': 'Lack of Recognition: This card represents a lack of recognition or feeling overlooked for your efforts. The reversed Six of Wands suggests that despite your hard work and accomplishments, you may not receive the acknowledgment or praise you desire. It encourages finding inner validation and celebrating personal growth.',
    'reversedDescription4': 'Self-Doubt: The reversed Six of Wands signifies self-doubt or a lack of confidence in your abilities. It suggests a need to overcome insecurities, fears, or negative self-talk that may be holding you back. This card encourages self-belief, positive affirmations, and seeking support to regain confidence.',
    'reversedDescription5': 'Loss of Support: The reversed Six of Wands represents a loss of support or a disconnection from a supportive community. It suggests feeling isolated or experiencing a lack of encouragement from others. This card encourages seeking new sources of support, surrounding yourself with positive influences, and building a new network of allies.',
  ...
  'seven of wands': {
    ...
    'uprightDescription2': 'Courage: This card signifies courage, bravery, and resilience. The Seven of Wands upright represents the strength to face challenges head-on, even when outnumbered or facing criticism. It encourages taking a bold stance, speaking up for yourself, and maintaining your integrity.',
    'uprightDescription3': 'Determination: The Seven of Wands represents determination, perseverance, and unwavering resolve. It symbolizes a strong will and the willingness to go the extra mile to achieve your goals. This card suggests staying committed to your path, even in the face of resistance or setbacks.',
    'uprightDescription4': 'Leadership: The Seven of Wands upright signifies leadership and taking charge of a situation. It represents being in a position of authority, guiding others, or taking the lead in a challenging endeavor. This card encourages assertive decision-making and inspiring others to follow your example.',
    'uprightDescription5': 'Inner Strength: The Seven of Wands represents inner strength, resilience, and self-belief. It symbolizes tapping into your inner resources and relying on your own abilities to overcome challenges. This card suggests having faith in yourself and your capabilities to overcome any obstacles that come your way.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Yielding: The reversed Seven of Wands suggests yielding, surrendering, or giving in to pressure. It signifies a lack of energy or motivation to continue fighting against obstacles or opposition. This card encourages reassessing your approach and considering alternative strategies.',
    'reversedDescription2': 'Overwhelmed: This card represents feeling overwhelmed, overburdened, or outnumbered. The reversed Seven of Wands suggests being unable to cope with the challenges or demands placed upon you. It encourages seeking support, delegating tasks, or taking a step back to regain your strength.',
    'reversedDescription3': 'Insecurity: The reversed Seven of Wands signifies insecurity, self-doubt, or a lack of confidence in your abilities. It suggests feeling vulnerable or questioning your position or decisions. This card encourages self-reflection, addressing insecurities, and seeking validation from within.',
    'reversedDescription4': 'Retreat: The reversed Seven of Wands represents a need for retreat, rest, or regrouping. It suggests acknowledging when it\'s necessary to step back from the battle and take time to recharge. This card encourages self-care, seeking solitude if needed, and coming back stronger after a period of rest.',
    'reversedDescription5': 'Compromise: The reversed Seven of Wands signifies the need for compromise or finding common ground. It suggests seeking a peaceful resolution or finding a middle ground in a conflict. This card encourages open-mindedness, active listening, and finding mutually beneficial solutions.',
  ...
  'eight of wands': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Swiftness: The Eight of Wands upright represents swift action, rapid progress, and quick movement. It signifies a surge of energy or events that unfold rapidly. This card suggests a fast-paced period of growth, advancement, or communication.',
    'uprightDescription2': 'Expansion: This card signifies expansion, broadening horizons, and opening up to new possibilities. The Eight of Wands upright represents the potential for expansion in various areas of life, such as career, relationships, or personal development. It suggests embracing opportunities and taking bold leaps forward.',
    'uprightDescription3': 'Momentum: The Eight of Wands represents momentum, forward motion, and a sense of flow. It symbolizes the momentum gained from previous efforts and the ability to carry that momentum forward. This card suggests embracing the energy of progress and riding the wave of success.',
    'uprightDescription4': 'Clear Communication: The Eight of Wands upright signifies clear communication, effective expression, and the free flow of ideas. It represents open channels of communication and the ability to express yourself with clarity and precision. This card encourages open and honest communication to achieve your desired outcomes.',
    'uprightDescription5': 'Transformation: The Eight of Wands represents transformation, breakthroughs, and significant changes. It signifies a period of rapid transformation or a breakthrough moment that propels you forward. This card suggests embracing change and allowing it to bring positive growth and transformation into your life.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Delays: The reversed Eight of Wands suggests delays, obstacles, or a slowdown in progress. It represents a lack of momentum or things not moving as swiftly as expected. This card encourages patience and a reassessment of your approach to overcome any delays.',
    'reversedDescription2': 'Miscommunication: This card represents miscommunication, misunderstandings, or a lack of clarity in communication. The reversed Eight of Wands suggests difficulties in expressing yourself clearly or receiving messages accurately. It encourages taking the time to clarify intentions and ensure effective communication.',
    'reversedDescription3': 'Stagnation: The reversed Eight of Wands signifies stagnation, lack of progress, or feeling stuck. It represents a lack of forward motion or a sense of being trapped in a particular situation. This card encourages finding ways to break free from the stagnation and rekindle the energy of progress.',
    'reversedDescription4': 'Overwhelm: The reversed Eight of Wands represents overwhelm, scattered energy, or a sense of being pulled in different directions. It suggests an excessive amount of tasks, responsibilities, or information to handle. This card encourages prioritization, delegation, and finding balance to overcome overwhelm.',
    'reversedDescription5': 'Blocked Energy: The reversed Eight of Wands signifies blocked energy, resistance, or obstacles hindering progress. It suggests that external or internal factors may be impeding your forward movement. This card encourages identifying and addressing any blockages to regain a sense of flow and momentum.',
  ...
  'nine of wands': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Resilience: The Nine of Wands upright represents resilience, strength, and perseverance. It signifies the ability to overcome challenges, withstand adversity, and keep moving forward. This card suggests staying determined and resilient in the face of obstacles.',
    'uprightDescription2': 'Persistence: This card signifies persistence, dedication, and a steadfast attitude. The Nine of Wands upright represents the willingness to go the extra mile and do whatever it takes to achieve your goals. It suggests staying committed and persistent in your efforts.',
    'uprightDescription3': 'Preparedness: The Nine of Wands represents preparedness, being ready for any obstacles or challenges that may arise. It symbolizes having a strategic plan in place and being well-equipped to handle difficulties. This card encourages being prepared and anticipating potential hurdles.',
    'uprightDescription4': 'Boundaries: The Nine of Wands upright signifies setting boundaries and protecting your energy. It represents the need to establish firm boundaries to maintain your well-being and protect yourself from external pressures or demands. This card suggests honoring your limits and prioritizing self-care.',
    'uprightDescription5': 'Last Push: The Nine of Wands represents the final push or the last stretch of a challenging journey. It signifies reaching the point of completion or near accomplishment. This card encourages giving it your all, staying focused, and persevering until the finish line.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Exhaustion: The reversed Nine of Wands suggests exhaustion, burnout, or feeling depleted. It represents a loss of energy or a sense of being overwhelmed by ongoing challenges. This card encourages taking a break, seeking support, and recharging your energy.',
    'reversedDescription2': 'Vulnerability: This card signifies vulnerability, feeling exposed, or a loss of defensiveness. The reversed Nine of Wands suggests letting down your guard or feeling more susceptible to criticism or setbacks. It encourages embracing vulnerability and seeking strength through openness.',
    'reversedDescription3': 'Giving Up: The reversed Nine of Wands represents the temptation to give up or surrender in the face of difficulties. It signifies a lack of motivation or the feeling that the challenges are too overwhelming to overcome. This card encourages reassessing your goals, seeking support, and finding renewed determination.',
    'reversedDescription4': 'Lack of Boundaries: The reversed Nine of Wands signifies a lack of boundaries or weakened defenses. It represents difficulties in maintaining personal boundaries or protecting your energy. This card encourages reassessing your boundaries, asserting yourself, and regaining control over your space and time.',
    'reversedDescription5': 'Resisting Change: The reversed Nine of Wands represents resistance to change or a fear of moving forward. It signifies a reluctance to embrace new opportunities or to step out of your comfort zone. This card encourages examining the underlying fears and beliefs that may be holding you back and being open to growth and transformation.',
  ...
  'ten of wands': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Burden: The Ten of Wands upright represents a heavy burden or responsibility. It signifies taking on more than you can handle or feeling overwhelmed by obligations. This card suggests the need to delegate, prioritize, or seek support to lighten the load.',
    'uprightDescription2': 'Hard work: This card signifies hard work, diligence, and perseverance. The Ten of Wands upright represents putting in significant effort and dedication to achieve your goals. It suggests staying focused, disciplined, and committed to seeing things through to completion.',
    'uprightDescription3': 'Challenges: The Ten of Wands represents challenges, obstacles, or setbacks that may arise on your path. It symbolizes the need to confront difficulties head-on and find creative solutions. This card encourages resilience and resourcefulness in the face of adversity.',
    'uprightDescription4': 'Completion: The Ten of Wands upright signifies the nearing completion of a project or a cycle. It represents the final stages of a journey, where the finish line is in sight. This card encourages staying motivated and persevering until the end.',
    'uprightDescription5': 'Release: The Ten of Wands represents the need to release or let go of burdensome responsibilities or obligations. It suggests evaluating your commitments and determining what is truly necessary or essential. This card encourages delegation, prioritization, and finding a healthy balance.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Overwhelm: The reversed Ten of Wands signifies a sense of overwhelm or being weighed down by burdens. It represents a feeling of being stretched too thin or struggling to manage numerous responsibilities. This card encourages seeking help, delegating tasks, or reevaluating priorities.',
    'reversedDescription2': 'Burnout: This card represents burnout, exhaustion, or a loss of motivation. The reversed Ten of Wands suggests feeling drained or lacking enthusiasm for your pursuits. It encourages self-care, rest, and finding ways to replenish your energy.',
    'reversedDescription3': 'Release: The reversed Ten of Wands signifies the need to release or let go of excessive responsibilities or obligations. It represents the opportunity to lighten your load and free yourself from unnecessary burdens. This card encourages setting boundaries and prioritizing self-care.',
    'reversedDescription4': 'Loss of direction: The reversed Ten of Wands represents a loss of direction or feeling unsure about your path forward. It signifies a need to reassess your goals or strategies and regain clarity. This card encourages seeking guidance or exploring new possibilities.',
    'reversedDescription5': 'Resistance: The reversed Ten of Wands signifies resistance to change or a reluctance to release burdens. It represents a fear of letting go or a stubborn attachment to the status quo. This card encourages examining the underlying fears and beliefs that may be holding you back and embracing the potential for growth and transformation.',
  ...
  'page of wands': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Enthusiasm: The Page of Wands upright represents youthful enthusiasm, passion, and a zest for life. It signifies a new spark of inspiration or creative energy entering your life. This card encourages embracing new opportunities with excitement and optimism.',
    'uprightDescription2': 'Exploration: This card symbolizes a spirit of adventure, curiosity, and a willingness to explore new territories. The Page of Wands upright suggests embarking on a journey of self-discovery or trying out new experiences. It encourages you to step out of your comfort zone and embrace the unknown.',
    'uprightDescription3': 'Creativity: The Page of Wands signifies the emergence of creative potential and the expression of your unique talents. It represents a time of inspiration and innovation, where new ideas and projects may take shape. This card encourages you to tap into your creative abilities and pursue your passions.',
    'uprightDescription4': 'Confidence: This card represents a growing sense of self-assurance and belief in your abilities. The Page of Wands upright signifies the courage to take risks and the confidence to express yourself authentically. It encourages you to trust in your talents and embrace your inner fire.',
    'uprightDescription5': 'Excitement: The Page of Wands signifies a sense of excitement and anticipation for what lies ahead. It represents a fresh start or a new phase filled with possibilities and opportunities. This card encourages you to approach life with a sense of wonder and embrace the joy of the present moment.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Lack of direction: The reversed Page of Wands represents a lack of direction or uncertainty about your path. It suggests feeling lost or unsure about your goals and aspirations. This card encourages reflection, self-exploration, and seeking clarity.',
    'reversedDescription2': 'Impatience: This card signifies impatience or a desire for quick results. The reversed Page of Wands suggests a tendency to rush into things without proper planning or consideration. It encourages you to cultivate patience and adopt a more strategic approach.',
    'reversedDescription3': 'Creative block: The reversed Page of Wands represents a creative block or a lack of inspiration. It signifies a temporary setback in your creative endeavors or a struggle to tap into your creative energy. This card encourages you to explore different sources of inspiration or seek support to overcome the block.',
    'reversedDescription4': 'Restlessness: This card symbolizes a sense of restlessness or a need for change. The reversed Page of Wands suggests a lack of fulfillment or a desire for new experiences. It encourages you to channel your energy in productive ways and explore opportunities for growth and expansion.',
    'reversedDescription5': 'Self-doubt: The reversed Page of Wands signifies self-doubt or a lack of confidence in your abilities. It represents a fear of taking risks or expressing yourself authentically. This card encourages you to work on building self-belief and embracing your unique gifts and talents.',
  ...
  'knight of wands': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Ambition: The Knight of Wands upright represents a strong drive and ambition to pursue your goals. It signifies a bold and assertive approach, pushing forward with determination and enthusiasm. This card encourages taking action and making progress towards your aspirations.',
    'uprightDescription2': 'Passion: This card symbolizes a fiery passion and intense energy. The Knight of Wands upright represents a deep sense of purpose and excitement about your endeavors. It encourages you to follow your heart and pursue what truly ignites your passion.',
    'uprightDescription3': 'Adventure: The Knight of Wands signifies a spirit of adventure and a desire for exploration. It represents a time of movement, travel, and new experiences. This card encourages you to embrace opportunities for growth and expand your horizons.',
    'uprightDescription4': 'Courage: This card represents bravery, fearlessness, and a willingness to take risks. The Knight of Wands upright signifies the confidence to face challenges head-on and overcome obstacles. It encourages you to trust your instincts and have faith in your abilities.',
    'uprightDescription5': 'Leadership: The Knight of Wands symbolizes natural leadership qualities and the ability to inspire others. This card represents taking charge of situations, leading by example, and asserting your influence. It encourages you to step into a position of authority and take responsibility for your actions.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Impulsiveness: The reversed Knight of Wands suggests a tendency to act impulsively or without considering the consequences. It signifies a lack of patience or a rushed approach to situations. This card encourages you to slow down, think before you act, and consider the long-term implications of your choices.',
    'reversedDescription2': 'Lack of direction: This card represents a lack of clear direction or focus. The reversed Knight of Wands suggests a scattered energy or difficulty in staying committed to a particular path. It encourages you to clarify your goals and priorities before taking action.',
    'reversedDescription3': 'Aggression: The reversed Knight of Wands signifies a potential for aggression or a hot-tempered nature. It represents a need to channel your energy in a more constructive and balanced way. This card encourages you to cultivate patience, diplomacy, and self-control.',
    'reversedDescription4': 'Burnout: This card symbolizes burnout or a depletion of energy. The reversed Knight of Wands suggests a need for rest and rejuvenation. It encourages you to take a step back, recharge, and find a healthy balance between your ambitions and self-care.',
    'reversedDescription5': 'Lack of follow-through: This card represents a lack of follow-through or inconsistency in your actions. The reversed Knight of Wands suggests a tendency to start projects or initiatives without seeing them through to completion. It encourages you to cultivate discipline and commitment to achieve your desired outcomes.',
  ...
  'queen of wands': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Passionate: The Queen of Wands upright embodies passion and enthusiasm. She is vibrant, energetic, and deeply connected to her desires and interests. This card represents a strong sense of purpose and the ability to inspire and motivate others.',
    'uprightDescription2': 'Confident: This card signifies self-assurance and a strong belief in your abilities. The Queen of Wands upright radiates confidence and assertiveness. She is comfortable in her own skin and embraces her personal power.',
    'uprightDescription3': 'Charismatic: The Queen of Wands is charismatic and magnetic. She has a natural ability to attract and captivate others with her presence and charm. This card represents a warm and engaging personality that draws people towards her.',
    'uprightDescription4': 'Leadership: This card symbolizes leadership qualities and the ability to take charge of situations. The Queen of Wands upright embodies strong leadership skills, assertiveness, and a knack for making decisions. She can inspire others to follow her lead.',
    'uprightDescription5': 'Creative: The Queen of Wands is deeply creative and expressive. She embraces her artistic and innovative nature, bringing a spark of creativity to everything she does. This card encourages you to tap into your own creative potential and express yourself authentically.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Domineering: The reversed Queen of Wands may indicate a tendency towards being domineering or controlling. This card suggests a need to soften your approach and allow others to express yourself and contribute your ideas.',
    'reversedDescription2': 'Insecurity: This card represents a lack of confidence and self-doubt. The reversed Queen of Wands may indicate feelings of insecurity or a struggle to assert yourself. It encourages you to work on building self-esteem and believing in your own abilities.',
    'reversedDescription3': 'Manipulative: The reversed Queen of Wands suggests a potential for manipulative behavior or using charm and charisma for self-serving purposes. This card warns against using your influence to manipulate others and encourages you to cultivate more authentic and transparent communication.',
    'reversedDescription4': 'Overbearing: This card signifies being overbearing or imposing your opinions on others. The reversed Queen of Wands may indicate a need to step back and allow others to have your own voice and space. It encourages you to practice active listening and respect the perspectives of others.',
    'reversedDescription5': 'Burnout: This card represents burnout or a loss of passion. The reversed Queen of Wands suggests a need for self-care and replenishment of energy. It encourages you to find balance, delegate tasks, and take time to nurture your own well-being.',
  ...
  'king of wands': {
    ...
    'uprightKeyword4': '',
    'uprightKeyword5': '',
    'uprightDescription1': 'Charismatic: The King of Wands upright exudes charisma and magnetism. He has a natural ability to inspire and influence others with his dynamic personality and leadership qualities.',
    'uprightDescription2': 'Confident: This card represents self-assurance and unwavering confidence. The King of Wands upright is self-assured in his abilities and decisions, which allows him to navigate challenges with a sense of certainty.',
    'uprightDescription3': 'Visionary: The King of Wands possesses a visionary mindset and an ability to see the big picture. He has a clear vision for the future and takes bold actions to bring his ideas to fruition.',
    'uprightDescription4': 'Inspirational: This card signifies the power of inspiration and motivation. The King of Wands upright has the ability to inspire and ignite passion in others, encouraging you to pursue your goals and dreams.',
    'uprightDescription5': 'Leadership: This card symbolizes strong leadership qualities. The King of Wands upright is a natural leader who takes charge, delegates effectively, and motivates others to achieve greatness.',
    ...
    'reversedKeyword4': '',
    'reversedKeyword5': '',
    'reversedDescription1': 'Arrogant: The reversed King of Wands may indicate arrogance or an inflated ego. This card warns against excessive pride and the tendency to disregard the opinions or contributions of others.',
    'reversedDescription2': 'Impulsive: This card represents a lack of careful planning or consideration of consequences. The reversed King of Wands may act impulsively, making hasty decisions without thinking through the potential outcomes.',
    'reversedDescription3': 'Dictatorial: The reversed King of Wands suggests a tendency towards being dictatorial or overly controlling. This card warns against using power or influence to dominate others and encourages a more collaborative approach.',
    'reversedDescription4': 'Lack of direction: This card signifies a lack of clear direction or purpose. The reversed King of Wands may struggle with indecisiveness or a loss of focus, making it difficult to achieve goals or make progress.',
    'reversedDescription5': 'Insecurity: This card represents feelings of insecurity or self-doubt. The reversed King of Wands may experience a lack of confidence in his abilities or struggle to assert his authority. It encourages the need to work on self-belief and address underlying insecurities.',
